...
function TopData() {
  ...
  return (
    <div className='sm:my-3 sm:p-6 p-2 bg-white/50 h-auto sm:h-[190px] flex sm:flex-row flex-row sm:gap-6 gap-0  items-center justify-between sm:mx-5 mx-2 rounded-lg'>
      <div className='flex flex-col items-center mr-3 text-center'>
      ...
      <div className='flex flex-col justify-center items-center text-red ml-3 text-center'>
